...
IMG_PATH_TEMPLATE = "./fst-badge-%s2.jpg"
badgeImageFiles = {
    BADGE_TYPE_NONE: IMG_PATH_TEMPLATE % "no",
    BADGE_TYPE_XIX: IMG_PATH_TEMPLATE % "xix",
    BADGE_TYPE_BAR: IMG_PATH_TEMPLATE % "ga",
    BADGE_TYPE_XIX | BADGE_TYPE_BAR: IMG_PATH_TEMPLATE % "xix",
    BADGE_TYPE_XIX | BADGE_TYPE_XVI: IMG_PATH_TEMPLATE % "xix",
    BADGE_TYPE_XVI: IMG_PATH_TEMPLATE % "ga",
    BADGE_TYPE_XVI | BADGE_TYPE_BAR: IMG_PATH_TEMPLATE % "ga",
    BADGE_TYPE_ORG: IMG_PATH_TEMPLATE % "org",
    BADGE_TYPE_FULL: IMG_PATH_TEMPLATE % "full",
}
